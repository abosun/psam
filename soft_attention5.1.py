...
SPLIT_PATH_TRAIN = 'ucfTrainTestlist/trainlist01.txt'
...
TOP_DIR_t = 'ucf_101_img_mul12_top8_max'
MID_DIR_t = 'ucf_101_img_mul12_mid35_max'
NECK_DIR_t = 'ucf_101_img_mul12_NECK_max'
OUT_DIR_t = 'ucf_101_img_mul12_NECK_OUT_max'
...
def attention_net(S, X, C, batch_size):
    ...
    with slim.arg_scope([slim.conv2d], activation_fn=None,
        ...
        B = slim.conv2d(X, c*3, [1, 1],activation_fn=tf.nn.relu, scope='conv1_1')
        B = slim.conv2d(B, 1, [1, 1],activation_fn=tf.nn.sigmoid, scope='conv1_2')
...
with tf.Session(config=cuda_set(GPU)) as sess:
    ...
    to_pb = pb_writer(sess,'softmax','models/SAH_tr_v1_')
