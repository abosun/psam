...
def read_i(dataset_dict, action,gpu_id):
    ...
    for file_path in file_path_list:
        ...
        out_path_mid = os.path.join(out_dir_mid, os.path.basename(file_path))
        savenpy(out_path_mid, mid_values[0])
        out_path_top = os.path.join(out_dir_top, os.path.basename(file_path))
        savenpy(out_path_top, top_values[0])
        out_path_neck = os.path.join(out_dir_neck, os.path.basename(file_path))
        savenpy(out_path_neck, neck_values[0])
        print(out_path_neck)
