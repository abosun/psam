...
MODEL_FILE = 'SA101_mid_s1__0.529.pb'
GPU = '3'
...
file = 'v_Surfing_g06_c02'#'v_TableTennisShot_g04_c05'#'v_PommelHorse_g06_c04'
#'v_Biking_g15_c02' #'v_BlowingCandles_g05_c01'#'v_HorseRiding_g16_c06'
img_i = 4
def read_split():
...
def resize299(img8,size):
    ...
    img = cv.resize(img299, (299,299))#*0.3
    #img[150:210,80:241] = img[150:210,80:241]*3
    #img[167:261,95:199] = img[167:261,95:199]*3
    #img[35:173,35:149] = img[35:173,35:149]*0.3
    #img[:170,:70] = img[:170,:70]*0.2
    #img[:221,83:] = img[:221,83:]*0.1
    #img[218:246,136:211] = img[218:246,136:211]*(1/0.1)
    #img[200:250,130:240] = img[200:250,130:240]*(1/0.1)
    #img[176:254,0:140] = img[176:254,0:140]*(1/0.7)
    #img[187:215,155:223] = img[187:215,155:223]*10
    #img[138:254, 62:237] = img[138:254, 62:237]*10
    #img[176:243,130:190] = img[176:243,130:190]*2.2#+np.max(img)*0.23
    #img[96:195,138:234] = img[96:195,138:234]*11
    return img
...
#    if_train = sess_att.graph.get_tensor_by_name("is_training:0")
    ...
    frame = get_one_img(file)[img_i]
    frame0 = frame.copy()
    print(Atte_mid[0][0].shape)
    img = resize299(np.reshape(Atte_mid[0],(35,35)),35)
    img = pinghua(img)
    f_max = frame.max()
    np.save(file+"_oradmap.npy", img)
    frame[:,:,0] = frame[:,:,0] * 0.2
    frame[:,:,1] = frame[:,:,1] * 0.2
    frame[:,:,2] = frame[:,:,2] * np.maximum(img*2,0.2)
    #frame = frame * (255.0/frame.max())
    cv.imwrite('keshihua.jpg',np.concatenate([frame0, frame],1))
